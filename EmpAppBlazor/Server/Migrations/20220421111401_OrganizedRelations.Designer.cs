...
namespace EmpAppBlazor.Server.Migrations
{
    ...
    [Migration("20220421111401_OrganizedRelations")]
    partial class OrganizedRelations
    {
            ...
            modelBuilder.Entity("EmpAppBlazor.Shared.Workload", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Comments = "",
                            DeliveryDate = new DateTime(2022, 5, 3, 13, 14, 1, 354, DateTimeKind.Local).AddTicks(5590),
                            OrderPlaced = new DateTime(2022, 4, 25, 13, 14, 1, 354, DateTimeKind.Local).AddTicks(5646),
                            ProductionStage = "Not Started",
                            ProjectId = 1,
                            RequiredDate = new DateTime(2022, 6, 5, 13, 14, 1, 354, DateTimeKind.Local).AddTicks(5640)
                        },
                        new
                        {
                            Id = 2,
                            Comments = "",
                            DeliveryDate = new DateTime(2022, 6, 14, 13, 14, 1, 354, DateTimeKind.Local).AddTicks(5651),
                            OrderPlaced = new DateTime(2022, 6, 22, 13, 14, 1, 354, DateTimeKind.Local).AddTicks(5666),
                            ProductionStage = "Not Started",
                            ProjectId = 2,
                            RequiredDate = new DateTime(2022, 5, 16, 13, 14, 1, 354, DateTimeKind.Local).AddTicks(5659)
                        },
                        new
                        {
                            Id = 3,
                            Comments = "",
                            DeliveryDate = new DateTime(2022, 7, 2, 13, 14, 1, 354, DateTimeKind.Local).AddTicks(5676),
                            OrderPlaced = new DateTime(2022, 4, 27, 13, 14, 1, 354, DateTimeKind.Local).AddTicks(5688),
                            ProductionStage = "Not Started",
                            ProjectId = 3,
                            RequiredDate = new DateTime(2022, 6, 15, 13, 14, 1, 354, DateTimeKind.Local).AddTicks(5680)
                        });
                });
